...
properties:
 ...
 90 BOOL m_bMoneyCollision        "Money Collision" = TRUE,
...
functions:
 ...
 void Precache(void)
  ...
  void MovingOn(void)
  {
	...
	if (!m_bMoneyCollision) {
	  SetCollisionFlags(GetCollisionFlags()|ECF_MONEY_PASS);
	}
    m_bMoving = TRUE;
  }
  void MovingOff(void)
  {
    ...
    if (m_bVeryBigBrush||!m_bMoneyCollision) {
